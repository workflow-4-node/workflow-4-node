            ...
            if (!activity.nonSerializedProperties.has(propertyName)) {
                if (_.isArray(propertyValue)) {
                    ...
                    for (let pv of propertyValue) {
                        if (is.activity(pv)) {
                            iPart.value.push(specStrings.hosting.createActivityInstancePart(pv.getInstanceId(execContext)));
                        }
                        else {
                            iPart.value.push(pv);
                        }
                    ...
                    item.parts.push(
                        {
                            name: propertyName,
                            value: specStrings.hosting.createActivityInstancePart(propertyValue.getInstanceId(execContext))
                        });
                }
                ...
                if (activityProperty) {
                    ...
                    if (activityId) {
                        ...
                        for (let pv of part.value) {
                            activityId = specStrings.hosting.getInstanceId(pv);
                            if (activityId) {
