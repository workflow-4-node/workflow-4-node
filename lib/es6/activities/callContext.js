...
function CallContext(executionContext, activityOrActivityId, scope) {
    ...
    this._activityInstanceId = this._activity ? this._activity.getId(executionContext) : null;
...
Object.defineProperties(
    CallContext.prototype,
    {
        ...
        executionState: {
            get: function () {
                return this._executionState || (this._activity ? (this._executionState = this._executionContext.getState(this.activityInstanceId)) : null);
            }
        },
        scope: {
            get: function () {
...
CallContext.prototype.next = function (childActivityOrActivityId, variables) {
    ...
    return new CallContext(
        ...
        child,
        this._scopeTree.next(this.activityInstanceId, child.getId(this.executionContext), part, child.id));
};
