    ...
    CallContext.prototype,
    {
        ...
        _parentActivityId: {
            get: function () {
                ...
                let state = this._executionContext.getState(this.instanceId);
        ...
        executionState: {
            get: function () {
                return this._executionState || (this._activity ? (this._executionState = this._executionContext.getState(this.instanceId)) : null);
            }
        },
        scope: {
            get: function () {
