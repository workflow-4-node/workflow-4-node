...
MemoryPersistence.prototype.getNextWakeupables = function(count) {
  ...
  try {
    for (var $__9 = void 0,
        $__8 = (this._instanceData.values())[Symbol.iterator](); !($__11 = ($__9 = $__8.next()).done); $__11 = true) {
      var data = $__9.value;
      {
        if (data.activeDelays) {
          ...
          try {
            for (var $__2 = void 0,
                $__1 = (data.activeDelays)[Symbol.iterator](); !($__4 = ($__2 = $__1.next()).done); $__4 = true) {
              var ad = $__2.value;
              {
                if (ad.delayTo <= now) {
                  result.push({
...
MemoryPersistence.prototype.getRunningInstanceHeadersForOtherVersion = function(workflowName, version) {
  ...
  try {
    for (var $__2 = void 0,
        $__1 = (this._instanceData.values())[Symbol.iterator](); !($__4 = ($__2 = $__1.next()).done); $__4 = true) {
      var data = $__2.value;
      {
