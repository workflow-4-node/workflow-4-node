...
KnownInstaStore.prototype.getNextWakeupables = function(count) {
  ...
  try {
    for (var $__10 = void 0,
        $__9 = (this._instances.values())[Symbol.iterator](); !($__12 = ($__10 = $__9.next()).done); $__12 = true) {
      var insta = $__10.value;
      {
        if (insta.execState === enums.activityStates.idle && insta.activeDelays) {
          ...
          try {
            for (var $__3 = void 0,
                $__2 = (insta.activeDelays)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
              var ad = $__3.value;
              {
                if (ad.delayTo <= now) {
                  result.push({
...
KnownInstaStore.prototype.getRunningInstanceHeadersForOtherVersion = function(workflowName, version) {
  ...
  try {
    for (var $__3 = void 0,
        $__2 = (this._instances.values())[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
      var insta = $__3.value;
      {
