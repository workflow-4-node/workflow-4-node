    ...
    while (true)
      switch ($ctx.state) {
        ...
        case 30:
          ...
          break;
        case 19:
          $__3 = void 0, $__2 = (oldVersionHeaders)[Symbol.iterator]();
          $ctx.state = 15;
          break;
        case 15:
    ...
    while (true)
      switch ($ctx.state) {
        case 0:
          ...
          $__7 = undefined;
          try {
            for ($__3 = void 0, $__2 = (self._registry.methodInfos(workflowName, methodName))[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
              info = $__3.value;
              {
