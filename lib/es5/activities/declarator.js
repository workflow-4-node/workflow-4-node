...
Declarator.prototype.run = function(callContext, args) {
  ...
  try {
    for (var $__1 = void 0,
        $__0 = (callContext.activity._getScopeKeys())[Symbol.iterator](); !($__3 = ($__1 = $__0.next()).done); $__3 = true) {
...
Declarator.prototype._varsGot = function(callContext, reason, result) {
  if (reason === Activity.states.complete) {
    ...
    try {
      for (var $__1 = void 0,
          $__0 = (this._activityVariableFieldNames)[Symbol.iterator](); !($__3 = ($__1 = $__0.next()).done); $__3 = true) {
        var fieldName = $__1.value;
        {
