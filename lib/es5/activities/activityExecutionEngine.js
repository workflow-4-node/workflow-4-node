...
ActivityExecutionEngine.prototype._hookContext = function() {
  ...
  self.context.on(Activity.states.run, function(args) {
    ...
    try {
      for (var $__3 = void 0,
          $__2 = (self._trackers)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
        var t = $__3.value;
        {
    ...
    while (true)
      switch ($ctx.state) {
        case 0:
          ...
          $__7 = undefined;
          try {
            for ($__3 = void 0, $__2 = ($arguments)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
              a = $__3.value;
              {
                args.push(a);
              }
...
ActivityExecutionEngine.prototype.invoke = function() {
  ...
  try {
    for (var $__3 = void 0,
        $__2 = (arguments)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
      var a = $__3.value;
      {
        args.push(a);
      }
