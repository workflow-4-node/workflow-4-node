...
ActivityExecutionContext.prototype._initialize = function(parent, activity, idCounter) {
  ...
  try {
    for (var $__3 = void 0,
        $__2 = (activity.immediateChildren(this))[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
      var child = $__3.value;
      {
...
ActivityExecutionContext.prototype.noopCallbacks = function(bookmarkNames) {
  ...
  try {
    for (var $__3 = void 0,
        $__2 = (bookmarkNames)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
      var name = $__3.value;
      {
        var bm = this._bookmarks.get(name);
        if (bm) {
...
ActivityExecutionContext.prototype.cancelExecution = function(scope, activityIds) {
  ...
  try {
    for (var $__3 = void 0,
        $__2 = (activityIds)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
      var id = $__3.value;
      {
  ...
  try {
    for (var $__10 = void 0,
        $__9 = (self._bookmarks.values())[Symbol.iterator](); !($__12 = ($__10 = $__9.next()).done); $__12 = true) {
      var bm = $__10.value;
      {
...
ActivityExecutionContext.prototype._cancelSubtree = function(scope, allIds, activityId) {
  ...
  try {
    for (var $__3 = void 0,
        $__2 = (state.childInstanceIds.values())[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
      var id = $__3.value;
      {
        self._cancelSubtree(scope, allIds, id);
      }
...
ActivityExecutionContext.prototype.getStateAndPromotions = function(serializer, enablePromotions) {
  ...
  try {
    for (var $__3 = void 0,
        $__2 = (this._activityStates.values())[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
      var s = $__3.value;
      {
