...
ScopeTree.prototype.setState = function(json, serializer) {
  ...
  try {
    ...
    try {
      for (var $__22 = void 0,
          $__21 = (this._nodes.values())[$traceurRuntime.toProperty(Symbol.iterator)](); !($__24 = ($__22 = $__21.next()).done); $__24 = true) {
        var node$__28 = $__22.value;
        {
          ...
          try {
            for (var $__15 = void 0,
                $__14 = (node$__28._keys)[$traceurRuntime.toProperty(Symbol.iterator)](); !($__17 = ($__15 = $__14.next()).done); $__17 = true) {
              var key = $__15.value;
              {
...
ScopeTree.prototype.hasProperty = function(currentNode, name) {
  ...
  try {
    for (var $__1 = void 0,
        $__0 = (currentNode.walkToRoot())[$traceurRuntime.toProperty(Symbol.iterator)](); !($__3 = ($__1 = $__0.next()).done); $__3 = true) {
      var node = $__1.value;
      {
