    ...
    while (true)
      switch ($ctx.state) {
        case 0:
          ...
          break;
        case 81:
          $ctx.state = (!visited.has(self)) ? 77 : -2;
          break;
        case 77:
          visited.add(self);
        ...
        case 76:
          ...
          break;
        case 74:
          $ctx.state = ($__30 < $__27.length) ? 70 : -2;
          break;
        case 34:
          $__30++;
          $ctx.state = 74;
        ...
        case 70:
          ...
          break;
        case 71:
          $ctx.state = (!(fieldName in $__28)) ? 34 : 68;
          break;
        case 68:
          $ctx.state = (self.hasOwnProperty(fieldName)) ? 64 : 34;
          break;
        case 64:
        ...
        case 43:
          ...
          break;
        case 32:
          $__3 = void 0, $__2 = (fieldValue)[Symbol.iterator]();
          $ctx.state = 28;
          break;
        case 28:
...
Activity.prototype.clone = function() {
  function makeClone(value, canCloneArrays) {
    if (value instanceof Activity) {
      ...
      try {
        for (var $__3 = void 0,
            $__2 = (value.values())[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
          var item = $__3.value;
          {
            newSet.add(item);
          }
      ...
      if (canCloneArrays) {
        ...
        try {
          for (var $__10 = void 0,
              $__9 = (value)[Symbol.iterator](); !($__12 = ($__10 = $__9.next()).done); $__12 = true) {
...
Activity.prototype.schedule = function(callContext, obj, endCallback) {
  ...
  try {
    ...
    if (state.many) {
      ...
      try {
        for (var $__3 = void 0,
            $__2 = (obj)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
          var value = $__3.value;
          {
            processValue(value);
            index++;
...
Activity.prototype.resultCollected = function(callContext, reason, result, bookmark) {
  ...
  try {
    ...
    if (endWithNoCollectAll || fail) {
      ...
      try {
        for (var $__3 = void 0,
            $__2 = (state.indices.keys())[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
          var id = $__3.value;
          {
            ids.push(id);
...
Activity.prototype.createScopePart = function() {
  ...
  if (this._createScopePartImpl === null) {
    ...
    try {
      for (var $__3 = void 0,
          $__2 = (this._getScopeKeys())[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
