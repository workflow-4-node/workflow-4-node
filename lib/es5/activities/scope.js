...
var scopeFactory = {create: function(scopeTree, node) {
    var Proxy;
    try {
    ...
    if (Proxy) {
      ...
      var getKeys = function() {
        ...
        try {
          for (var $__3 = void 0,
              $__2 = (scopeTree.enumeratePropertyNames(node))[$traceurRuntime.toProperty(Symbol.iterator)](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
            var key = $__3.value;
            {
              if (!has.has(key)) {
                keys.push(key);
