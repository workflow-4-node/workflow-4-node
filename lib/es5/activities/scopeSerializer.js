...
var arrayHandler = {
  serialize: function(serializer, activity, execContext, getActivityById, propName, propValue, result) {
    ...
    if (_.isArray(propValue)) {
      ...
      try {
        for (var $__3 = void 0,
            $__2 = (propValue)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
          var pv = $__3.value;
          {
            if (is.activity(pv)) {
  ...
  deserialize: function(serializer, activity, getActivityById, part, result) {
    ...
    if (_.isArray(part.value)) {
      ...
      try {
        for (var $__3 = void 0,
            $__2 = (part.value)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
          var pv = $__3.value;
          {
...
var scopeSerializer = {
  ...
  serialize: function(execContext, getActivityById, enablePromotions, nodes, serializer) {
    ...
    try {
      for (var $__24 = void 0,
        ...
        var node = $__24.value;
        {
          ...
          try {
            for (var $__10 = void 0,
                $__9 = (node.properties())[Symbol.iterator](); !($__12 = ($__10 = $__9.next()).done); $__12 = true) {
              var prop = $__10.value;
              {
                if (!activity.nonSerializedProperties.has(prop.name)) {
                  ...
                  try {
                    for (var $__3 = void 0,
                        $__2 = (this.handlers)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
          ...
          if (promotedProperties && activity.promotedProperties) {
            ...
            try {
              for (var $__17 = void 0,
                  $__16 = (activity.promotedProperties)[Symbol.iterator](); !($__19 = ($__17 = $__16.next()).done); $__19 = true) {
    ...
    if (promotedProperties) {
      ...
      try {
        for (var $__31 = void 0,
            $__30 = (promotedProperties.entries())[Symbol.iterator](); !($__33 = ($__31 = $__30.next()).done); $__33 = true) {
          var kvp = $__31.value;
          {
      ...
      while (true)
        switch ($ctx.state) {
          ...
          case 73:
            ...
            break;
          case 62:
            $__17 = void 0, $__16 = (json)[Symbol.iterator]();
            $ctx.state = 58;
            break;
          case 58:
          ...
          case 53:
            ...
            break;
          case 38:
            $__10 = void 0, $__9 = (item.parts)[Symbol.iterator]();
            $ctx.state = 34;
            break;
          case 34:
          ...
          case 27:
            ...
            break;
          case 16:
            $__3 = void 0, $__2 = (this.handlers)[Symbol.iterator]();
            $ctx.state = 12;
            break;
          case 12:
