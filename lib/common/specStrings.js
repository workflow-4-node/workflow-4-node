...
var specStrings = {
    ...
    hosting: {
        ...
        {
            return guids.markers.activityProperty + ":" + methodName;
        },
        getActivityPropertyName: function (obj)
        {
            if (_.isString(obj) && obj.indexOf(guids.markers.activityProperty) === 0)
            {
                return obj.substr(guids.markers.activityProperty.length + 1);
            }
            return null;
        },
        ...
        {
            if (_.isString(obj) && obj.indexOf(guids.markers.activityInstance) === 0)
            {
                return obj.substr(guids.markers.activityInstance.length + 1);
            }
            return null;
        },
