...
{
    if (!this.bookmarkName) throw new ex.ValidationError("Bookmark name expected.");
    if (ResumeBookmark.validReasons.indexOf(this.reason) == -1) throw new ex.ValidationError("Reason value '" + this.reason + "' is not valid.");
