...
Declarator.prototype.run = function (context, args)
{
    ...
    {
        if (is.defined(this.activity[fieldName]))
        {
            if (is.undefined(this.activity.constructor.prototype[fieldName]) && !this.activity.reservedProperties.exists(fieldName) && !this.activity.nonScopedProperties.exists(fieldName))
            {
