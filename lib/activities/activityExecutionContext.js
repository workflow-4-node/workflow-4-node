    ...
    return new ScopeTree(
        {
            ...
            {
                return self.createBookmark.call(self, context.activityId, name, callback);
            },
        ...
        function(id) { return self._getKnownActivity(id) });
}
...
ActivityExecutionContext.prototype._doResumeBookmark = function (callContext, bookmark, reason, result, noRemove)
{
    ...
    scope[bookmark.endCallback].call(scope, callContext, reason, result, bookmark);
}
