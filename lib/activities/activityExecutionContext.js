    ...
    return new ScopeTree(
        {
            ...
            {
                context.activity.complete.call(context.activity, context, result);
            },
            cancel: function (context)
            {
                context.activity.cancel.call(context.activity, context);
            },
            idle: function (context)
            {
                context.activity.idle.call(context.activity, context);
            },
            fail: function (context, e)
            {
                context.activity.fail.call(context.activity, context, e);
            },
            end: function (context, reason, result)
            {
                context.activity.end.call(context.activity, context, reason, result);
            },
            schedule: function (context, obj, endcallback)
            {
                context.activity.schedule.call(context.activity, context, obj, endcallback);
            },
            resultCollected: function (context, reason, result, bookmarkName)
            {
                context.activity.resultCollected.call(context.activity, context, reason, result, bookmarkName);
            },
            createBookmark: function (context, name, callback)
            {
                return self.createBookmark.call(self, context, name, callback);
            },
            resumeBookmark: function (context, name, reason, result)
            {
                self.resumeBookmarkInternal.call(self, context, name, reason, result);
            }
        });
}
...
ActivityExecutionContext.prototype._doResumeBookmark = function (callContext, bookmark, reason, result, noRemove)
{
    ...
    if (is.undefined(scope[bookmark.endCallback]))
    {
    ...
    scope[bookmark.endCallback].call(callContext.scope, callContext, reason, result, bookmark);
}
