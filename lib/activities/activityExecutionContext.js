    ...
    return new ScopeTree(
        {
            ...
            {
                if (this.activity) return self.createBookmark.call(self, this.activity.id, name, callback);
            },
...
ActivityExecutionContext.prototype._registerKnownActivity = function (activity)
{
    ...
    if (this._isComposite(activity)) activity.ensureImplementationCreated();
};
...
{
    return obj["__typeTag"] == guids.types.activity || this._isComposite(obj);
}

ActivityExecutionContext.prototype._isComposite = function (obj)
{
    return obj["__typeTag"] == guids.types.composite;
}
...
ActivityExecutionContext.prototype.getBookmarkTimestamp = function(name, throwIfNotFound)
{
    ...
    if (bm === undefined && throwIfNotFound) throw new Error("Bookmark '" + name + "' not found.");
...
/* SERIALIZATION */
ActivityExecutionContext.prototype.getStateAndPromotions = function(serializer)
{
    ...
    var serialized = serializer.toJSON({
