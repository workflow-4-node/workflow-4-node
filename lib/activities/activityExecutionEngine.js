...
{
    var idx = -1;
    this._trackers.forEach(function(t,i)
    {
        if (t._impl === tracker)
        {
            idx = i;
...
/* SERIALIZATION */
ActivityExecutionEngine.prototype.getStateAndPromotions = function(serializer)
{
    if (!_.isObject(serializer)) throw new Error("Argument 'serializer' is not an object.");

    this._initialize();
    return this._context.getStateAndPromotions(serializer);
}
