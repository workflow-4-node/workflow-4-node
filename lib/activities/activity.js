...
Activity.prototype.start = function (callContext)
{
    ...
    self.emit(myCallContext, Activity.states.run);
    return new Promise(function(resolve, reject)
    {
        state.once(Activity.states.end, function (reason, result)
        {
            //console.log("end: " + myCallContext.activityId + " - " + reason);
            switch (reason)
            {
        ...
        console.log("run: " + myCallContext.activityId);
