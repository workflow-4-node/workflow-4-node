...
WorkflowPersistence.prototype.enterLock = function (lockName, enterLockTimeoutMs, inLockTimeoutMs)
{
    ...
    return asyncHelpers.aggressiveRetry(
        function() { return self._enterLockForCreatedInstance(lockName, inLockTimeoutMs) },
        function (lockInfo)
        {
...
WorkflowPersistence.prototype._enterLockForCreatedInstance = function (lockName, inLockTimeoutMs)
{
...
WorkflowPersistence.prototype.loadState = async(
    function (workflowName, instanceId)
    {
        ...
        var state = await(Promise.resolve(this._impl.loadState(workflowName, instanceId)));
...
WorkflowPersistence.prototype.loadPromotedProperties = async(
    function (workflowName, instanceId)
    {
        ...
        // Without: idleMethods, promotedProperties
        var state = await(Promise.resolve(this._impl.loadPromotedProperties(workflowName, instanceId)));
        return state;
    });
