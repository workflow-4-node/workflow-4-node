...
{
    return Q(this._impl.getRunningInstanceIdHeader(workflowName, instanceId, methodName));
}

WorkflowPersistence.prototype.loadState = function (workflowName, instanceId)
{
    // Without: idleMethods, promotions
    return Q(this._impl.loadState(workflowName, instanceId));
}

WorkflowPersistence.prototype.removeState = function(workflowName, instanceId, succeeded, error)
{
    return Q(this._impl.removeState(workflowName, instanceId, succeeded, error));
}
