...
MongoDBPersistence.prototype._ensureIndexes = function()
{
    ...
    return Promise.settle([
        ...
        new Promise(function(reject, resolve)
        {
            self._locksCollection.ensureIndex({ name: 1, heldTo: 1 }, { w: 1, unique: false }, function(e)
            {
                if (e) reject(e); else resolve();
            });
        }),
        ...
        new Promise(function(reject, resolve)
        {
            self._stateCollection.ensureIndex({ "idleMethods.methodName": 1 }, { w: 1, unique: false }, function(e)
            {
                if (e) reject(e); else resolve();
            });
        }),
