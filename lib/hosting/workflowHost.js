...
WorkflowHost.prototype._checkIfInstanceRunning = async(
    function* (workflowName, instanceId)
    {
        ...
        {
            return (yield this._persistence.isRunning(workflowName, instanceId)) || (yield this._persistence.isLockHeld(specStrings.hosting.doubleKeys(workflowName, instanceId)));
        }
        else
        {
