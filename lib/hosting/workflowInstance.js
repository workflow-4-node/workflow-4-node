...
WorkflowInstance.prototype.create = Promise.coroutine(
...
WorkflowInstance.prototype._enterLockForCreatedInstance = Promise.coroutine(
    function* (lockInfo)
    {
...
WorkflowInstance.prototype.callMethod = Promise.coroutine(
