...
WorkflowInstance.prototype._invoke = function()
{
    var self = this;
...
WorkflowInstance.prototype.callMethod = async(
    function* (methodName, args)
    {
        ...
        try
        {
            yield self._resume(methodName, args);
...
WorkflowInstance.prototype._resume = function (methodName, args)
{
    var self = this;
    return new Promise(function(resolve, reject)
    {
        setImmediate(function()
        {
            self._engine.resumeBookmark(specStrings.hosting.createBeginMethodBMName(methodName), enums.ActivityStates.complete, args)
                .then(function(r)
                {
                    resolve(r);
                },
