...
WorkflowInstance.prototype.create = async(function (workflow, methodName, args, lockInfo)
{
    var self = this;
            ...
            if (createMethodReached)
            {
                ...
                if (instanceIdPath)
                {
                    ...
                    if (self._host.persistence)
                    {
                        ...
                        await (self._host.persistence.renameLock(lockInfo.id, specStrings.hosting.doubleKeys(self.workflowName, self.id)))
                    }
                }
